...
const script: Step[] = [
  ...
  { role: "user", text: "오서산 억새밭이 생각나네. 은빛 억새가 산을 가득 덮던 모습이 아직도 눈에 선해." },
  { role: "agent", text: "와, 정말 멋진 풍경이었을 것 같아요. 그때 어떤 기분이 드셨나요?" },
  { role: "user", text: "바람에 억새가 물결치면 마음이 고요해지고, 세월이 잠시 멈춘 듯했지." },
  { role: "agent", text: "정말 아름다운 순간이었네요. 오늘 들려주신 이야기는 ‘오서산 억새밭의 고요함’으로 기록해도 될까요?" },
